...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_Master_R2C0 = QLabel(self.gridLayoutWidget)
        self.label_Master_R2C0.setObjectName(u"label_Master_R2C0")
        self.label_Master_R2C0.setMinimumSize(QSize(32, 32))
        self.label_Master_R2C0.setMaximumSize(QSize(32, 32))

        self.gridLayout_1_Master.addWidget(self.label_Master_R2C0, 2, 0, 1, 1)
        ...
        self.label_Master_R0C0 = QLabel(self.gridLayoutWidget)
        self.label_Master_R0C0.setObjectName(u"label_Master_R0C0")
        self.label_Master_R0C0.setMinimumSize(QSize(64, 64))
        self.label_Master_R0C0.setMaximumSize(QSize(64, 64))
        self.label_Master_R0C0.setBaseSize(QSize(64, 64))
        self.label_Master_R0C0.setScaledContents(False)
        self.label_Master_R0C0.setAlignment(Qt.AlignCenter)
        self.label_Master_R0C0.setIndent(0)

        self.gridLayout_1_Master.addWidget(self.label_Master_R0C0, 0, 0, 2, 2)
        ...
        self.gridLayout_1_Master.setColumnMinimumWidth(0, 32)
        self.gridLayout_1_Master.setColumnMinimumWidth(1, 32)
        self.gridLayout_1_Master.setColumnMinimumWidth(2, 32)
        self.gridLayout_1_Master.setColumnMinimumWidth(3, 32)
        self.gridLayout_1_Master.setRowMinimumHeight(0, 32)
        self.gridLayout_1_Master.setRowMinimumHeight(1, 32)
        self.gridLayout_1_Master.setRowMinimumHeight(2, 32)
        self.gridLayout_1_Master.setRowMinimumHeight(3, 32)
        ...
        self.label_T1B1 = QLabel(self.groupBox_T1B1)
        self.label_T1B1.setObjectName(u"label_T1B1")
        self.label_T1B1.setGeometry(QRect(50, 115, 67, 17))
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_T1B1.sizePolicy().hasHeightForWidth())
        self.label_T1B1.setSizePolicy(sizePolicy)
        self.label_T1B1.setMaximumSize(QSize(16777215, 16777213))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_Master_R2C0.setText(QCoreApplication.translate("MainWindow", u"R2C0", None))
        ...
        self.label_Master_R0C0.setText(QCoreApplication.translate("MainWindow", u"R0C0", None))
        self.pushButton_Master_R0C3.setText(QCoreApplication.translate("MainWindow", u"R0C3", None))
        self.pushButton_Master_R3C3.setText(QCoreApplication.translate("MainWindow", u"R3C3", None))
        self.groupBox_2_Tabs.setTitle("")
        self.groupBox_T1B1.setTitle("")
        self.label_T1B1.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
